// components/MusicPlayerControls.jsx
...
const MusicPlayerControls = () => {
    return (
        <div className="fixed bottom-0 left-0 w-full bg-black text-white py-4 px-6 flex flex-col justify-center items-center z-20">
            {/* Thanh tiến trình */}
